...
public class BikeParkingLot extends ParkingLot {
    ...
    public BikeParkingLot(Polygon area, Double longtitude, Double latitude, String name, boolean barrierfree, AccessRight accessRight, boolean charging, ParkingStatus parkingStatus, ParkingType parkingType) {
        super.area = area;
